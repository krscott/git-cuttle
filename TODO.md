...
- [ ] Implement `workspaces.json` schema v1 read/write models with validation and invariants.
...
- [ ] Ensure prune treats unknown/unavailable PR status as not merged.
...
- [ ] Build integration test matrix covering user-visible behavior and command contracts in `DESIGN.md`.
...
- [ ] Add operational troubleshooting docs for rollback recovery and common git-state errors.
